"""Application-user OAuth for a Microsoft Dataverse environment."""
...
class DataverseAuth:
    ...
    def access_token(self, *, refresh: bool = False) -> str:
        ...
        try:
            response = self.session.post(
                ...
                data={
                    ...
                    "scope": self.environment_url.rstrip("/") + "/.default",
                },
        ...
        if response.status_code != 200:
            raise AuthenticationError("Microsoft Entra rejected the Dataverse credentials")
        try:
